...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
	<link rel="stylesheet" href="judgeDisplay.css">
  ...
  <body>
	<div class="container-flex px-4 py-4">
			<video autoplay="autoplay" loop="true">
			  <source src="assets/judgeBg.m4v" type="video/mp4">			  
			</video>
			<div class="row">
				...
				<div class="judgeBox " >
					...
					<div class="scores">
						...
						<div class="scoreRow judgeRow winnerRow">
							<div class="winner"><span class="winnerName" id="j1w">-</span></div>
						</div>
					</div>
				</div>
				<div class="judgeBox " >
					...
					<div class="scores">
						...
						<div class="scoreRow judgeRow winnerRow">
							<div class="winner"><span class="winnerName" id="j2w">-</span></div>
						</div>
					</div>
				</div>
				<div class="judgeBox" >
					...
					<div class="scores">
						...
						<div class="scoreRow judgeRow winnerRow">
							<div class="winner"><span class="winnerName" id="j3w">-</span></div>
						</div>
					</div>
				</div>
			</div>
