...
<html lang="en">
  ...
  <body>
	...
	<div class="container-flex px-4">
		...
		<h1>
				<h4 class="float-right">Assing Match <span id="theMatchInfo"></span> to Cage: 
					<div class="form-check form-check-inline">
					  <input class="form-check-input" type="radio" name="matchSpot" id="inlineRadio1" value="1">
					  <label class="form-check-label" for="inlineRadio1">1</label>
					</div>
					<div class="form-check form-check-inline">
					  <input class="form-check-input" type="radio" name="matchSpot" id="inlineRadio2" value="2">
					  <label class="form-check-label" for="inlineRadio2">2</label>
					</div>
					<div class="form-check form-check-inline">
					  <input class="form-check-input" type="radio" name="matchSpot" id="inlineRadio3" value="3" >
					  <label class="form-check-label" for="inlineRadio3">3 <span class="text-secondary h6">(30lb)</span></label>
					</div>
