...
<head>
	...
	<?php } else if ($mask == 0) { ?>
	<link rel="stylesheet" href="onScreenv3.css">
	<?php  } else { ?>
	<link rel="stylesheet" href="onScreenv3Mask.css">
...
<div class="container">
	<div class="matchBar">
		...
		<div class="leftBotImage" ></div>
		<div class="leftBotName"><div class="leftWin" id="leftWin"></div ><span id="player2" ></span></div>
		
		<div class="matchClock">Loading...</div>
		<div class="rightBotName"><div class="rightWin"></div><span id="player1" ></span></div>
		<div class="rightBotImage" ></div>
	</div>
	<div class="matchDetails">

	<div class="matchNumber"></div>

	<div class="bracket">Loading Bracket </div> 
	<div class="round"> </div>
